...
=======
- \pretitle{\begin{center} 
>>>>>>> a557e66f4a34320f26eb003c8a129ae629bd8125
...
print(Q1)
```
According to Figure\@ref(fig:A1), developed countries such as United States and France both have the lowest inflation rate in 2015. This is because in 2015, the crude oil price collapsed. [@stocker], and the global economy has not recovered from the GFC yet [@inflation1]. 
