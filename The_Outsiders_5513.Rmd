...
```{r allcountries, fig.width=15, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r agriculture, fig.width=10, fig.height=5, echo=FALSE, warning=FALSE, message=FALSE}
byyear %>% 
...
```{r industry, fig.width=10, fig.height=5, echo=FALSE, warning=FALSE, message=FALSE}
byyear %>% 
...
```{r services, fig.width=10, fig.height=5, echo=FALSE, warning=FALSE, message=FALSE}
byyear %>% 
...
```{r allvars, fig.width=15, fig.height=15, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r Intermediatedeved, fig.cap = "Unemployment with intermediate education in developed countries", echo=FALSE, warning=FALSE, message=FALSE, fig.pos='hold'}
